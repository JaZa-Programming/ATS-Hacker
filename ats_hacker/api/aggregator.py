...
def aggregate(doc: str) -> json:
    ...
    # Lowercase entire job posting in order to count uppercase and lowercase as
    # same word (Example: Software == software)
    # Create list of individual words in job posting
    # If word is not in dictionary it will be added with 1. If already exists,
    # 1 will be added to existing occurrence.
